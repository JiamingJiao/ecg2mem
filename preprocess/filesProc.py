...
def getPecg(src_path, dst_path, elec_pos, gnd_pos, inter_size):
    ...
    for src_path in src_path_list:
        ...
        pecg_no_ref = pseudoEcg.calcPecgSequence(phie, elec_pos)
...
def getBinaryPecg(src_path, dst_path, elec_pos, gnd_pos, inter_size, **find_peaks_args):
    src_path_list = sorted(glob.glob(os.path.join(src_path, '*.npy')))
